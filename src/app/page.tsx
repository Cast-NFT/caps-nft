          ...
          <div className="glass-panel rounded-[32px] p-6 sm:p-8 motion-rise">
            <div className="grid grid-cols-1 gap-8 xl:grid-cols-[0.88fr_1.12fr]">
              ...
              <div>
                ...
                <a
                  href="https://opensea.io/collection/echocapsul-924092586"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-5 flex w-full items-center justify-center gap-3 rounded-2xl border border-[#2081e2]/30 bg-[#2081e2]/10 px-5 py-4 text-sm font-semibold text-[#2081e2] transition hover:bg-[#2081e2]/20 hover:border-[#2081e2]/50"
                >
